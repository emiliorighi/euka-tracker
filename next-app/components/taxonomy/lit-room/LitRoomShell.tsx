...
export function LitRoomShell({
  ...
  return (
    <div className="lit-room-root flex min-h-0 min-w-0 flex-1 flex-col gap-4">
      <header className="lit-room-header min-w-0 shrink-0 border-b border-border/60 pb-4">
          ...
          <div className="min-w-0 space-y-2">
            ...
            <div className="space-y-1">
              ...
              <p className="max-w-2xl text-sm text-muted-foreground">
                Descend through bioluminescent chambers. Doorways lead deeper; floor stones lift
                for specimen detail without leaving the room.
              </p>
              {focusRow && (
